...
export const generateMetadata = ({
  title = `mntdigital | Premium IPTV Services with HD Quality`,
  description = `mntdigital offers premium IPTV services with a wide range of channels, on-demand content subscription plans. Stream anytime, anywhere, with HD quality.`,
  icons = [
    {
      rel: "icon",
